...
## Why the relational model refuses to die
...
## Transactions: the promise and its fine print
...
## The query plan: the database explains itself
...
## Connections are file descriptors with feelings
